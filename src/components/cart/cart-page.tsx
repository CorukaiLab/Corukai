      ...
      {lines.length === 0 ? (
        ...
        <div className="cart-layout">
          ...
          <aside className="cart-summary">
            ...
            <div><span>Ediciones por comprobar</span><strong>{lines.length}</strong></div>
            <hr />
            ...
            <p className="purchase-note">Amazon confirma el precio y la disponibilidad vigentes de cada edición.</p>
          </aside>
        </div>
      )}
    </main>
